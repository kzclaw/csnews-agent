 ...
 * Entity Engine Phase 2: Keyword-based NER (v0.34)
 *
...
serve(async (req: Request) => {
  ...
  try {
    ...
    // Build hashStr for dedup (consistent with topic_key approach)
    ...
    // v0.34 placeholder: co-occurrence only (Signal Engine in future phase)
