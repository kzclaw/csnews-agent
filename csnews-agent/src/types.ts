...
// ============================================================
// Entity 类型（单一真相源 · v0.37.87 从 4 处独立定义收敛到这里）
// ============================================================
/**
 * 实体分类（v0.37.87 扩展：person/org/place → +time/concept）
 * - person: 人名
 * - org: 机构 / 组织
 * - place: 地名 / 地点
 * - time: 时间 / 日期片段（"8月" "1日" "Q3"）
 * - concept: 概念 / 话题 / 通用词（"AI" "经济" "上市"）
 */
export type EntityType = 'person' | 'org' | 'place' | 'time' | 'concept';
