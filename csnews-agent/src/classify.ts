...
// ============================================================
// 自分类候选 A: 用 bge-m3 embedding 替换 250+ 词硬编码
// 0 硬编码哲学: 类别和 seeds 都从 R2 读
// 自进化闭环: 分类错 review → seeds 自动更新
//
// 历史: 旧版用关键词兜底, v0.36.13 起主路径走 bge-m3 embedding 自分类,
//       旧 classifyRule 降级为兜底
//
